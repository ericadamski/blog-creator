...
var BlogPostEditor = React.createClass({displayName: "BlogPostEditor",
  ...
  render : function() {
    ...
    return (
      React.createElement("div", {className: "post-editor"}, 
    ...
    return (
      React.createElement("div", {className: "blog-post"}, 
        React.createElement("h2", {className: "post-title"}, 
          this.props.title, 
          React.createElement("h4", {className: "post-autor"}, 
            this.props.author
          )
        ), 
        React.createElement("span", {className: "post-preview", dangerouslySetInnerHTML: {__html: rawMarkup}}), 
        React.createElement("a", {href: this.props.title}, "Continue Reading ...")
      )
    );
  }
});
